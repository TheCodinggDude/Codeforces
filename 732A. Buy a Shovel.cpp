...
void solve() {
	ll costforoneshovel , randomcurrency;
	cin>>costforoneshovel>>randomcurrency;
	ll shovels = 1;
	ll cost = costforoneshovel;
	while(cost%10 != 0 && cost%10 != randomcurrency) {
		shovels++;
		cost += costforoneshovel;
	}
	cout<<shovels;
}
